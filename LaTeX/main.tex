...
\maketitle
    ...
    existe une mesure \textcolor{red}{de probabilité} $\Lambda$ sur $[0,1]$ telle que, lorsqu'on a $b$ lignées,
    ...
    par une mesure de probabilité $\Lambda$ sur $[0,1]$. 
    ...
    terminant presque sûrement en $1$.
    ...
    en remarquant que $\lambda_{b,b} = \int_0^1 x^{b-2}\,\Lambda(dx) \leq 1$,
    \[
    H(b) = \frac{1}{\lambda_b} + \sum_{k=2}^{b-1} p_{b,k} H(b-k+1)
    ...
    \begin{proof}
        ...
        = \frac{19954284839411683}{11337879079537330} > 1.7599662\dots > 1.75
        \]
    \end{proof}
    Nous conjecturons que le théorème peut être étendu pour tout $n>6$.
    A notre connaissance l'étude ce phénomène n'est pas documenté.
