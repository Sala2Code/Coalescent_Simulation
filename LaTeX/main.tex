...
\maketitle
    ...
    \begin{figure}[H]
        \centering
        \includesvg[width=\textwidth]{kingmanplot}
        \caption{Simulation de Kingman ($n=20$).
        \textbf{Au centre} : La généalogie réalisée, ne montrant que des fusions par paires.
        \textbf{À gauche} : La densité du TMRCA. La ligne pointillée grise indique l'espérance théorique (Eq. \ref{eq:tmrca-kingman}).
        \textbf{À droite} : La courbe en escalier du nombre de lignées restantes.}
