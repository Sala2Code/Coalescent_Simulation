...
sur $[0,1]$ avec $\beta>1,\gamma>1$ \textcolor{red}{T'es sûr ? car pour les alpha on n'a pas du tout > 1...} (classiquement les polynômes de Jacobi sont définis sur $[-1,1]$ mais par un changement 
