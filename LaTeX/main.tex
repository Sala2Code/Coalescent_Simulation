...
\maketitle
   ...
   \textcolor{blue}{L'échelle de temps ici est en unités de $N$ générations, avec $N\gg n$ puisque
    ...
    \begin{figure}[htbp]
        \centering
        \includesvg[width=0.75\textwidth]{photo/plot_foret_pas_grande.svg}
        \caption{Illustration : comparaisons de réalisations/distributions du TMRCA correspondant à deux mesures indiscernables pour $n$ fixé (voir la section « Une forêt pas si grande »).}
        \label{fig:foret-pas-grande}
    \end{figure}
