...
et du fait que les polynômes de Jacobi sont  orthogonaux por le poids  de la forme $x^\beta(1-x)^\gamma$ 
...
Par conséquent, nous gardons $\alpha \in ]1,2[$.
    ...
    où $C(\alpha)$ est une constante qui provient du comportement asymptotique des polynômes de Jacobi.
