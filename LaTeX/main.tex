...
Ainsi en conditionnant par $\mathcal{F}_{T_1}$,
   ...
   \textcolor{blue}{L'échelle de temps ici est en unités de $N$ générations, avec $N\gg n$ puisque
    ...
    \begin{proposition}\label{}
        ...
        de densité 
        \[ 
        f_\varepsilon(x) = 1 + \varepsilon P_{n-2}(2x-1)
        \]

        Alors, pour tout $0<\varepsilon<1$, 
        \[
        \tau_\Lambda \overset{\mathcal{L}}{=} \tau_{\Lambda_\varepsilon}
        \]
    ...
    \begin{proof}
        ...
        = \int_0^1 x^r dx + \varepsilon \int_0^1 x^r P_{n-2}(2x-1) dx
